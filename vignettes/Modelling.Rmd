...
ggplot(QM_TPI_500_Model, mapping=aes(x=UHI_est, y= Diff_Zoll)) +
  ...
  theme_bw()
ggsave("../figures/models/Burger_Bern/Burger_Bern_TPI_500.png", width=6.5, height=4, dpi=300)
...
dates = c("2024-08-23", "2024-07-27", "2024-09-26") #highest UHI, average UHI, lowest UHI
```
