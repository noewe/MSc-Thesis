...
result <- LUR_int_model(
  ...
  spat_vars = c("AD", "OS_GA_25", "LC_B_250", "OS_AC_750", "OS_FO_1000", "TPI_500", "VH_150"),
...
result <- LUR_int_model(
  ...
  spat_vars = c("AD", "OS_GA_25", "LC_B_250", "OS_AC_750", "OS_FO_1000", "TPI_500", "VH_150", "OS_wa_150"),
...
result <- LUR_int_model(
  ...
  target = "UHI",
  target_name = "mean nighttime UHI",
  met_vars = c("wind_S", "precip_boolean", "rad_1d", "humidity_1d"),
  spat_vars = c("AD", "OS_GA_25", "LC_B_250", "OS_AC_750", "OS_FO_1000", "TPI_500", "VH_150"),
...
# Model with predictors from Boruta variable selection
```{r}
preds_VS <- read.csv("../results/Variable Selection/Boruta_results_adapted.csv") 
...
for (date in dates) {
  predict_temperature_map(
    ...
    meteo_dir = "../data/Geodata/Meteo_daily",
    lulc_dir = "../data/Geodata/LULCTopo_Gauss",
    output_path = "../results/models/LUR_INT_TH_Bor_red/",
    uhi_range = c(-1.3, 5)
  )
}
```
