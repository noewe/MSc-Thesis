...
MeteoCH_data <- MeteoCH_data |>
  ...
  mutate(wind_dir_10min_NS = ifelse(wind_dir_10min > 90 & wind_dir_10min <= 270, "S", "N"),
         ...
         wind_dir_d_WE= ifelse(wind_dir_d > 0 & wind_dir_d <= 180, "E", "W"))
...
```{r}
MeteoCH_data <- read.csv("../data/IDAWEB/MeteoCH_Thun.csv") 
  # Enter one value in the column time in the first row: 2024-05-01 02:00
MeteoCH_data$time[1] <- "2024-05-01 00:00:00"
...
MeteoCH_data_hourly <- MeteoCH_data |>
 ...
 MeteoCH_data_hourly <- MeteoCH_data_hourly |>
    ...
    mutate(
      ...
      air_temp_5d = zoo::rollmean(air_temp, k = 24 * 5, fill = NA, align = "right"),
      ...
      pressure_5d = zoo::rollmean(pressure, k = 24 * 5, fill = NA, align = "right"),
      ...
      wind_vel_5d = zoo::rollmean(wind_vel, k = 24 * 5, fill = NA, align = "right"),
      ...
      wind_vel_lake_5d = zoo::rollmean(wind_vel_lake, k = 24 * 5, fill = NA, align = "right"),
      ...
      rad_5d = zoo::rollmean(rad, k = 24 * 5, fill = NA, align = "right"),
      ...
      humidity_5d = zoo::rollmean(humidity, k = 24 * 5, fill = NA, align = "right"),
      ...
      precip_5d = zoo::rollsum(precip, k = 24 * 5, fill = NA, align = "right"),
      ...
      water_temp_5d = zoo::rollmean(water_temp, k = 24 * 5, fill = NA, align = "right"),
      ...
      water_temp_surface_5d = zoo::rollmean(water_temp_surface, k = 24 * 5, fill = NA, align = "right")) |>
...
MeteoCH_data_night <- MeteoCH_data_night |>
  mutate(precip_8h_boolean = ifelse(precip_8h > 0.3, 1, 0),
         ...
         precip_5d_boolean = ifelse(precip_5d > 0.3, 1, 0))
...
MeteoCH_data_night <- MeteoCH_data_night |>
  mutate(
    ...
    wind_dir_5d_class = classify_wind_dir(wind_dir_5d),
    wind_dir_5d_NS = ifelse(wind_dir_5d > 90 & wind_dir_5d <= 270, "S", "N"),
    wind_dir_5d_WE = ifelse(wind_dir_5d > 0 & wind_dir_5d <= 180, "E", "W"),
    wind_S_5d = ifelse(wind_dir_5d_NS == "S", wind_vel_5d, 0),
    wind_N_5d = ifelse(wind_dir_5d_NS == "N", wind_vel_5d, 0),
    wind_W_5d = ifelse(wind_dir_5d_WE == "W", wind_vel_5d, 0),
    wind_E_5d = ifelse(wind_dir_5d_WE == "E", wind_vel_5d, 0)
    ) |>
  # Classify lake wind
  mutate(
    ...
    wind_dir_lake_5d_class = classify_wind_dir(wind_dir_lake_5d),
    wind_dir_lake_5d_NS = ifelse(wind_dir_lake_5d > 90 & wind_dir_lake_5d <= 270, "S", "N"),
    wind_dir_lake_5d_WE = ifelse(wind_dir_lake_5d > 0 & wind_dir_lake_5d <= 180, "E", "W"),
    wind_S_lake_5d = ifelse(wind_dir_lake_5d_NS == "S", wind_vel_lake_5d, 0),
    wind_N_lake_5d = ifelse(wind_dir_lake_5d_NS == "N", wind_vel_lake_5d, 0),
    wind_W_lake_5d = ifelse(wind_dir_lake_5d_WE == "W", wind_vel_lake_5d, 0),
    wind_E_lake_5d = ifelse(wind_dir_lake_5d_WE == "E", wind_vel_lake_5d, 0)
  ) 
```
